...
cout<<"if you want to remove any item in your shopping cart, Then write: \n\n   YES \n\n   NO " <<endl;
	 string R;  cin>>R;
	 
	if(R=="YES" || R=="Yes"||R=="yes"){
	   cout<<" How many elements you want to remove  \n";
	int r,ritems[r]; cin>>r; 
	cout << "Please enter the index of the elements you want to Remove: \n";
	for(int i=0;i<r;i++){
       cin >> ritems[r];
       while (ritems[r]<1 || ritems[r]>15) {
	  ...
	  cout<<" OKAY, your price is calculating.....\n ";
